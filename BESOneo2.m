...
% 4) Print current results and plot design
        ...
        colormap(gray); imagesc(-reshape(x, ny, nx));
        axis equal tight off; drawnow;
    end
end    

%% Frame reinforcement problem as presented in "A new
% generation 99 line Matlab code for compliance topology optimization and
% its extension to 3D" by Ferrari and Sigmund, 2020, pp.11
%
% Replace section Pre. 3) with the following:
